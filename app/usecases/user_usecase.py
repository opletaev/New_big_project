...
class UserUsecase:
    ...
    async def create_user(
        ...
        hashed_password = AuthService(self.service).hashed_password(body.password)  # Тут дерьмо какое-то
